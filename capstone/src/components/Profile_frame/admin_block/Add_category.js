...
export const Add_category = ({}) => {
  ...
  let add_category = (e) =>
    document
      .querySelector("#add_new_category")
    ...
    <div className="row">
      ...
      >
        <div className="col-auto">
          <label htmlFor="id_type_category" className="visually-hidden">
            Type category:{" "}
          </label>
          <select
            name="type_content"
        ...
        {isMainCategory && (
          <div className="col-auto">
            <label htmlFor="valid_ext" className="visually-hidden">
              Extensions devided by coma
            </label>
            <input
        ...
        <div className="col-auto">
          <label className="visually-hidden" htmlFor="name_category">
